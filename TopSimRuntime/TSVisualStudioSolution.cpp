...
//            else
//            {
//                std::cout << vstype << GB18030ToTSString(" 目录获取失败，请安装")<< vstype << std::endl;
//            }
...
TSString TSVisualStudioSolution::ReadLuaConfig()
{
    ...
    if (Lua.empty())
    {
        std::cerr << IdlName + ".lua "<< "为空" << std::endl;
    }
